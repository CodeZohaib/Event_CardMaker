            ...
            <div class="row ">
              <div class="col-md-6 printable-content" >
               <div class="card">
                    ...
                    <div class="card-body">
                        <img src="files/edi.jpg" id="uploadImage" alt="Eid Image" width="200"><br><br>
                        <p class="message">Wishing you joy, peace, and prosperity on this auspicious occasion of Eid.</p>
                    </div>
                </div>
              </div>
