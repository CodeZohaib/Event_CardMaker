            ...
            <div class="row">
               <div class="col-md-6 printable-content">
                <div class="card" style="background-color: white !important;">
                  <h2 class="text-center " id="title" style="padding:10px">Wedding Invitation</h2>
                  <hr>
                  <h4 class="text-center " id="names">Mr. John Doe &amp; Miss Jane Smith</h4>
                  <p class="text-center " id="occasion">are getting married!</p>
                  <p class="text-center " id="date">Date: January 1, 2024</p>
                  <p class="text-center " id="time">Time: <span id="fromTime">5:00 PM</span> to <span id="endTime">9:00 PM</span></p>
                  <p class="text-center " id="location">Location: Example Venue, City</p>
                  <p class="text-center " id="message">Please join us in celebrating our special day.</p>
                  <p class="text-center " id="rsvp">RSVP by December 1, 2023</p>
                  <p class="text-center " id="email">Email: example@example.com</p>
                </div>
              </div>
