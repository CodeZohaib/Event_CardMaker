            ...
            <div class="row">
              <div class="col-md-6 printable-content">
                 <div class="card" style="margin-top:50px">
                  <center><img src="files/user.png" id="uploadImage" alt="Profile Picture"></center>
                  <h4 id="name">John Doe</h4>
                  <p id="profession">Web Developer</p>
                  <hr>
                  <p >Email: <span id="email">john.doe@example.com</span></p>
                  <p>Website: <span id="detail">www.johndoe.com</span></p>
                  <p>Phone: <span id="phone">+1 123-456-7890</span></p>
