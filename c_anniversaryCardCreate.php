          ...
          <div class="container">
            ...
            <div class="row ">
              <div class="col-md-6 printable-content">
                <div class="card card-container draggable resizable" style="margin-top:100px;">
                  <h1 class="card-title draggable resizable" id="title">Happy Anniversary!</h1>
                  <h2 class="card-subtitle draggable resizable" id="subtitle">Celebrating Our Love</h2>
                  <p class="card-message message draggable resizable">"I know everyone says that they're the luckiest person in the world, but I truly am the luckiest in the world. Because I have you!</p>
                  <div class="card-footer draggable resizable">
     ...
     $('.myTextarea').jqte();
      ...
      function updateMessage(message) {
        if (message.trim() !== '') {
          ...
          $('.message').html('"I know everyone says that theyre the luckiest person in the world, but I truly am the luckiest in the world. Because I have you!');
        }
      }
