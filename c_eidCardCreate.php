    ...
    <!-- ======= About Section ======= -->
       ...
       <div class="container-fluid text-center">
          <div class="container">
            ...
            <input type="text" name="eidCardCreate" hidden value="eidCardCreate">
            <div class="row ">
              <div class="col-md-6 printable-content" >
               <div class="card draggable resizable">
                    <div class="card-header draggable resizable" id="title">
                        <h4>Eid Mubarak</h4>
                    </div>
                    <div class="card-body">
                        <img src="files/edi.jpg" id="uploadImage" class="draggable resizable" alt="Eid Image" width="200"><br><br>
                        <p class="message draggable resizable">Wishing you joy, peace, and prosperity on this auspicious occasion of Eid.</p>
                    </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="row mt-4">
                  <div class="col-md-6">
                    ...
                    <input type="color" name="titleBgColor" id="backgroundcolortitle" class="form-control" value="#f7f7f7">
                  </div>
  ...
  $(document).ready(function() {
      ...
      function updateMessage(message) {
        if (message.trim() !== '') {
          ...
          $('.message').html('Wishing you joy, peace, and prosperity on this auspicious occasion of Eid..');
        }
      }
