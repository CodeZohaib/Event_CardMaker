            ...
            <div class="row" >
              <div class="col-md-6 printable-content ">
                   <div class="card draggable resizable">
                    <div class="card-title draggable resizable" id="title">Happy Birthday!</div>
                    <div class="card-subtitle draggable resizable"><b>Name: </b><span id="names">John Doe</span></div>
                    <div class="card-subtitle draggable resizable"><b>DOB: </b><span id="DOB">19-04-1995</span></div>
                    <div class="card-subtitle subtitle draggable resizable">Wishing you a fantastic day filled with joy and happiness.</div>
                    <div class="card-message message draggable resizable">May all your dreams and wishes come true.</div>
                    <div class="card-footer footer draggable resizable">Best wishes from all of us!</div>
                  </div>
              </div>
                ...
                <div class="row mt-4">
                 ...
                 <div class="row mt-4">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-12">
                    <h5>Message:</h5>
                    <input type="text" name="message" id="messageInput" class="form-control myTextarea" required>
                  </div>
...
$(document).ready(function() {
      ...
      function updateMessage(message) {
        if (message.trim() !== '') {
          ...
          $('.message').html('May all your dreams and wishes come true.');
        }
      }
